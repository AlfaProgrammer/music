<template>
  ...
  <section class="mb-8 py-20 text-white text-center relative">
    ...
    src="assets/img/introduction-music.png" alt="immagine"/>
  </section>
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden
        ...
        <div class="py-4 text-left px-6">
          ...
          <form>
            <!-- Email -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="login-email">
                <input type="email"
          ...
          <form>
            <!-- Name -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="name-input">
                <input type="text"
                  class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                    duration-500 focus:outline-none focus:border-black rounded"
            ...
            <!-- Email -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="register-email">
                <input type="email"
                  class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                    duration-500 focus:outline-none focus:border-black rounded"
            ...
            <!-- Age -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="age-input">
                <input type="number"
                  class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                   duration-500 focus:outline-none focus:border-black rounded" id="age-input"/>
                  Age
              </label>
            </div>
            <!-- Password -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="register-password">
                <input type="password"
                  class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                    duration-500 focus:outline-none focus:border-black rounded"
            ...
            <!-- Confirm Password -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="register-password-confirm">
                <input type="password"
                  class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                    duration-500 focus:outline-none focus:border-black rounded"
                  placeholder="Confirm Password" id="register-password-confirm"/>

              Confirm Password 2 input
              </label>
            </div>
            <!-- Country -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="country-input">
                <select
                  class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
            ...
            <!-- TOS -->
            <div class="mb-3 pl-6">
              <label class="inline-block" for="terms-input">
